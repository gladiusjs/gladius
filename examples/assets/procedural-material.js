function proc( options ) {
  ...
  var colorTexture = (options.hasOwnProperty( "colorTexture" )) ? options.colorTexture : '../assets/images/tank-diffuse.jpg';
  var normalTexture = (options.hasOwnProperty( "normalTexture" )) ? options.normalTexture : '../assets/images/tank-normal.jpg';
  var bumpTexture = (options.hasOwnProperty( "bumpTexture" )) ? options.bumpTexture : '../assets/images/tank-bump.jpg';
